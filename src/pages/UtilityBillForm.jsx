...
import { createUtilityBill, downloadBillPdf } from '../services/billApiService';
...
const UtilityBillForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await createUtilityBill(billData);
            ...
            toast.success(
                (t) => (
                    <div className="flex flex-col gap-2">
                        ...
                        <button 
                            onClick={() => {
                                downloadBillPdf('utility', response.id || response._id, response.invoice_number);
                                toast.dismiss(t.id);
                            }}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">Month</label>
                                    ...
                                    <div>
                                        <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">Year</label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">Electricity Units (kWh)</label>
                                ...
                                <div>
                                    <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">Electricity Rate ({BILLING_CONSTANTS.CURRENCY_SYMBOL})</label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">Motor Hours</label>
                                ...
                                <div>
                                    <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">Motor Rate ({BILLING_CONSTANTS.CURRENCY_SYMBOL}/hr)</label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">Maintenance Fee</label>
                                ...
                                <div>
                                    <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">Tax (%)</label>
                                ...
                                <div>
                                    <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">Due Date</label>
